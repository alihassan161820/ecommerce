												...
												<div class="col-md-3">
														<div class="product-image-wrapper">
															<div class="single-products">
																	...
																	<div class="clockdiv clockdiv3" id="clockdiv{{$product->auction_id}}"data-value="{{$product->auction_id}}">
															...
															<div class="choose choose-plus">
																<ul class="nav nav-pills nav-justified">
																	@if($product->auction_id)																	
																	<li><a href="{{Request::root()}}/auction/{{$product->auction_id}}"><i class="fa "></i>Auction Details</a></li>
																	@else
																	<li><a href="{{Request::root()}}/item/{{$product->product_id}}"><i class="fa "></i>Product Details</a></li>
																	@endif																</ul>
															</div>
														</div>
													</div>
